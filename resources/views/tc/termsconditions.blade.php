...
<head>
    ...
    <title>Cloud Copy - Terms and Conditions</title>

    <link rel="icon" href="{{ asset('images/cloudcopy1.png') }}">
    <link rel="stylesheet" href="{{ asset('styles/global.css') }}">
    <link rel="stylesheet" href="{{ asset('styles/tc/termsconditions/termsconditions.css') }}">
</head>
<body>
    <div class="tc-container">
        <div class="tc-content">
            <h2>UK Website Terms and Conditions</h2>
            <p class="intro">
                Welcome to Cloud Copy. Please note that if you continue to 
                browse and use this website, you are agreeing to comply with 
                and be bound by the following terms and conditions of use, 
                which together with our privacy policy govern Cloud Copy’s 
                relationship with you in relation to this website. If you 
                disagree with any part of these terms and conditions, please 
                do not use our website.
            </p>
            <p class="pro">
                The term Cloud Copy or 'us' or 'we' refers to the owner of the 
                website whose registered office is [address]. Our company 
                registration number is 12919904 . The term 'you' refers to the 
            ...
            <ul>
                ...
                <li>
                    ...
                    links are provided for your convenience to provide further information. They 
                    do not signify that we endorse the website(s). We have no responsibility for 
